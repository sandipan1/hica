    ...
    async def execute(self, task_description: str) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                ...
                display_content=f"Subagent task finished.\nFinal Message: {final_response}",
                raw_result=result,
            )
            ...
            return ToolResult(
                ...
                display_content=f"Error during subagent execution: {str(e)}",
                raw_result=result,
            )
        finally:
